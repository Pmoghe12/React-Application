...
export default class TicTacToe extends React.Component{
  ...
  render(){
    ...
    full rounded primary style={styles.reset}><Text style={styles.btn_text}>Reset Game</Text></Button>
    <Button  full rounded primary style={styles.reset}
     onPress={()=>this.props.navigation.push("Dashboard")}><Text style={styles.btn_text}>Quit Game</Text></Button>
